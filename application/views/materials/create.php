        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-info">
                    <h4 class="mt-4 ml-3">New Material Record</h4>
                    <hr>
                    <div class="card-body">
                        <form class="form-horizontal" action="<?php echo base_url('index.php/materials/create') ?>" method="post" autocomplete="off">
                            ...
                            <div class="form-group mt-5">
                                <div class="row">
                                    <div class="col-md-4 mx-auto">
                                        <input type="file" id="input-file-max-fs" class="dropify" data-max-file-size="50M" />
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" type="text" name="input_unit_qty">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
