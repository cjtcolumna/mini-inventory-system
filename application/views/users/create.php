        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-outline-info">
                    ...
                    <hr>
                    <div class="card-body">
                        <form class="form-horizontal" action="<?php echo base_url('index.php/users/create') ?>" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" type="password" name="input_confirm_password">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a class="btn btn-secondary" href="<?php echo base_url('index.php/users/list') ?>">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
