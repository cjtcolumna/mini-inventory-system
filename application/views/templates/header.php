                        ...
                        <nav class="navbar top-navbar navbar-expand-md navbar-light">
                                ...
                                <div class="navbar-collapse">
                                        ...
                                        <ul class="navbar-nav my-lg-0">
                                                <li class="d-flex justify-content-center align-items-center mr-1"><b class="text-white">Hi!, <?php echo $firstname ?></b></li>
                                                <li class="nav-item dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                                                <ul class="dropdown-user">
                                                                        ...
                                                                        <li role="separator" class="divider"></li>
                                                                        <li><a href="<?php echo base_url('index.php/dashboard/logout') ?>"><i class="fa fa-power-off"></i> Logout</a></li>
                                                                </ul>
                                                        </div>
                                                </li>
                                        </ul>
